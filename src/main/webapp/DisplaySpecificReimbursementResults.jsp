...
<title>(M)All Pending Reimbursements</title>
</head>
<% String username = (String) session.getAttribute("username"); 
	int searchid = request.getIntHeader("searchid");%>
<h2>You Are logged in as <%=username%></h2>
<body>
<%
	ReimbursementDAO reimburse = new ReimbursementDAOImpl();
	List<ReimbursementUser> ruser = reimburse.getReimbursementByUserId(searchid);
